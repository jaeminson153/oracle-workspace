...
insert into emp01 values('John',2000);
savepoint sp;
delete from emp01 where first_name = 'Beta';
rollback to sp;
commit;

create table emp02(emp_id number primary key, first_name varchar2(50), salary number);

select * from emp02;

insert into emp02 values(2,'dong',9000);

update emp02 set first_name = 'min' where emp_id = 2;
